...
protected:
  ...
  // Фабрика стеков создается конструктором для генерации
  // стеков, необходимых для реализации внешнего итератора
...
template <class T>
StackFactory<Tree<T>::Node*> * Tree<T>::stackFactory = new ListStackFactory<Node*>();
